...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('books.index')); ?>",
        columns: [
    ...
    $('body').on('click', '.editBook', function () {
      ...
      $.get("<?php echo e(route('books.index')); ?>" +'/' + book_id +'/edit', function (data) {
    ...
    $('body').on('click', '.deleteBook', function () {
        ...
        $.ajax({
            type: "DELETE",
            url: "<?php echo e(route('books.store')); ?>"+'/'+book_id,
            success: function (data) {
                table.draw();
            },
            error: function (data) {
...
<?php /**PATH /home/steve/blog/resources/views/book.blade.php ENDPATH**/ ?>